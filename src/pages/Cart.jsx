          ...
          (<div className='flex justfiy-center flex-col md:flex-row gap-x-[90px] w-11/12 max-w-[900px] mr-28'>
            ...
            <div className='flex flex-col justify-center items-center md:justify-between'>
              <div className='mt-20'>
                ...
                <p className='mt-6'>
                  <span className='font-black text-white'>Total Items : {cart.length}</span>
                </p>
              </div>

              <div className='mb-20'>
                <p className='font-semibold text-white'>Total Amount : <span className='font-extrabold'>${totalAmount}</span></p>
